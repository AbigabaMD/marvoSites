        ...
        <div className="row">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <div className="row">
              <div className="col-lg-11">
                <span className="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Innovative Fintech Solutions</span>
                ...
                <div className="logos mb-4" data-aos="fade-up" data-aos-delay="400">
                  ...
                  <div className="logos-images d-flex gap-4 align-items-center">
                    <img className="img-fluid" src="/Nova-Bootstrap-1.0.0/assets/images/logo/actual-size/logo-air-bnb__black.svg" alt="Company 1" style={{ width: '110px' }} />
                    <img className="img-fluid" src="/Nova-Bootstrap-1.0.0/assets/images/logo/actual-size/logo-ibm__black.svg" alt="Company 2" style={{ width: '80px' }} />
                    <img className="img-fluid" src="/Nova-Bootstrap-1.0.0/assets/images/logo/actual-size/logo-google__black.svg" alt="Company 3" style={{ width: '110px' }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-6">
            <div className="hero-img">
              <img className="img-card img-fluid" src="/Nova-Bootstrap-1.0.0/assets/images/card-expenses.png" alt="Image card" data-aos="fade-down" data-aos-delay="600" />
              <img className="img-main img-fluid rounded-4" src="/Nova-Bootstrap-1.0.0/assets/images/hero-img-1-min.jpg" alt="Hero Image" data-aos="fade-in" data-aos-delay="500" />
            </div>
          </div>
        </div>
      </div>
