        ...
        <div className="row">
          <div className="col-lg-6 mb-4 mb-lg-0">
            <div className="row">
              <div className="col-lg-11">
                <span className="hero-subtitle text-uppercase">Innovative Fintech Solutions</span>

                <h1 className="hero-title mb-3">Secure, Efficient, and User-Friendly Financial Services</h1>

                <p className="hero-description mb-4 mb-lg-5">
          ...
          <div className="col-lg-6">
            <div className="hero-img">
              <img className="img-card img-fluid" src="/assets/images/card-expenses.png" alt="Image card" />
              <img className="img-main img-fluid rounded-4" src="/assets/images/hero-img-1-min.jpg" alt="Hero Image" />
            </div>
          </div>
        </div>
      </div>
