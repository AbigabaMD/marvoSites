...
const About = () => {
  const features = [
    { icon: 'bi-check', text: 'Innovation' },
    { icon: 'bi-check', text: 'Security' },
    { icon: 'bi-check', text: 'User-Centric Design' },
    { icon: 'bi-check', text: 'Transparency' },
    { icon: 'bi-check', text: 'Empowerment' }
  ]
